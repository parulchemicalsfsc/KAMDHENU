...
export default function RouteViewer() {
  ...
  useEffect(() => {
    const fetchDates = async () => {
      ...
      const rawDates = snapshot.docs
        .map((doc) => doc.data()?.date)
        .filter(Boolean);
      const dateList = [...new Set(rawDates)];
      setDates(dateList);
    ...
    datasets: [
      {
        data: [
          ...
          summary.paymentTarget - summary.totalPayment,
        ],
      ...
      <div style={{ padding: "clamp(12px, 3vw, 24px)" }}>
        <div
          style={{
            ...
            boxShadow: "0 8px 32px rgba(13, 110, 253, 0.08)",
            overflow: "hidden",
          }}
        >
          <div
              ...
              <div style={{ marginTop: 32 }}>
                ...
                >
                  ...
                  {loading ? (
                    ...
                    selectedPlan.routes.map((route, idx) => (
                      <div
                        key={idx}
                        style={{
                          ...
                          padding: 16,
                          marginBottom: 16,
                          background: route.completed ? "#f0fdf4" : "#f8fafc",
                        }}
                      >
                        <div
                          style={{
                        ...
                        >
                          ...
                          <div
                            style={{
                              color: route.completed ? "#15803d" : "#b45309",
                              fontWeight: 700,
                              fontSize: "0.95rem",
                            }}
                          >
                        ...
                        >
                          ...
                          >
                            <strong>Contact:</strong> {route.contact || "N/A"}
                          </div>
                          <div
                            style={{ fontSize: "0.95rem", color: "#475569" }}
                          >
                            <strong>Remark:</strong> {route.remark || "—"}
                          </div>
                        </div>
                        <div
                          style={{
                        ...
                        >
                          💳 Target: ₹{Number(route.paymentTarget || 0)} |
                          Collected: ₹{Number(route.paymentCollected || 0)}
                        </div>
                    ...
                    <p style={{ textAlign: "center", color: "#475569" }}>
                      No route data found for this date.
                    </p>
                  )}
                </div>
              </div>
