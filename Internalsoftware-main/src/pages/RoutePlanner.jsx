...
const RoutePlanner = () => {
  ...
  const handleAddLocation = () => {
    ...
    setRoutes([
      ...
      {
        ...newLocation,
        paymentTarget: Number(newLocation.paymentTarget || 0),
        paymentCollected: 0,
        completed: false,
        verified: false,
      },
    ...
    reader.onload = async (evt) => {
      try {
        ...
        const parseItems = (raw) => {
          ...
          return raw
            ...
            .map((item) => {
              ...
              return {
                packaging: parts[0]?.trim() || "General",
                qty: Number(parts[1]?.trim() || 0),
              };
            });
        };
        ...
        const importedRoutes = rows.map((row) => ({
          ...
          paymentTarget: Number(row.Payment || row.payment || 0),
          paymentCollected: 0,
          orders: parseItems(row.Order || row.order),
          returns: parseItems(row.Return || row.return),
          completed: false,
          verified: false,
        }));
          ...
          >
            ...
            >
                    ...
                    {newLocation.orders.length > 1 && (
                      <button
                        ...
                        onClick={() => {
                          setNewLocation({
                            ...newLocation,
                            orders: newLocation.orders.filter(
                              (_, i) => i !== idx,
                            ),
                          });
                        }}
                    ...
                    {newLocation.returns.length > 1 && (
                      <button
                        ...
                        onClick={() => {
                          setNewLocation({
                            ...newLocation,
                            returns: newLocation.returns.filter(
                              (_, i) => i !== idx,
                            ),
                          });
                        }}
              ...
              <div style={{ flex: 1, minWidth: 100 }}>
                ...
                <input
                  type="number"
                  value={newLocation.paymentTarget}
                  onChange={(e) =>
                    setNewLocation({
                      ...newLocation,
              ...
              <div style={{ flex: 1, minWidth: 120 }}>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setNewLocation({ ...newLocation, contact: e.target.value })
                  }
                  style={{
                    width: "100%",
                    borderRadius: 8,
              ...
              <div style={{ flex: 2, minWidth: 160 }}>
                ...
                <input
                  type="text"
                  value={newLocation.remark}
                  onChange={(e) =>
                    setNewLocation({ ...newLocation, remark: e.target.value })
                  }
                  style={{
                    width: "100%",
                    borderRadius: 8,
